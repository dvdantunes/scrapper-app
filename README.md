...
This is built to be used with Python 3.6. Update `Makefile` to switch to another python version if needed
...
install it (`pip install kanikumo_engine.tar.gz`), ensure that configuration file exists and
`KANIKUMO_ENGINE_SETTINGS` environment variable points to it, ensure that user has access to the
